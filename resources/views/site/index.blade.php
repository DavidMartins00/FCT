...
<section id="home" class="parallax-section">
     ...
     <video controls autoplay loop muted>
          <source src="../frontOffice/videos/video.mp4" type="video/mp4">
          ...
          <div class="row">
               ...
               <div class="col-md-6 col-sm-6">
                    ...
                    <div class="project-item">
                         <a href="../frontOffice/images/project-image1.jpg" class="image-popup">
                              <img src="../frontOffice/images/project-image1.jpg" class="img-responsive" alt="">
               ...
               <div class="col-md-6 col-sm-6">
                    <!-- PROJECT ITEM -->
                    <div class="project-item">
                         <a href="../frontOffice/images/project-image2.jpg" class="image-popup">
                              <img src="../frontOffice/images/project-image2.jpg" class="img-responsive" alt="">
               ...
               <div class="col-md-6 col-sm-6">
                    <!-- PROJECT ITEM -->
                    <div class="project-item">
                         <a href="../frontOffice/images/project-image3.jpg" class="image-popup">
                              <img src="../frontOffice/images/project-image3.jpg" class="img-responsive" alt="">
               ...
               <div class="col-md-6 col-sm-6">
                    <!-- PROJECT ITEM -->
                    <div class="project-item">
                         <a href="../frontOffice/images/project-image4.jpg" class="image-popup">
                              <img src="../frontOffice/images/project-image4.jpg" class="img-responsive" alt="">
          ...
          <div class="row">
               ...
               <div id="owl-team" class="owl-carousel">
                    <div class="col-md-4 col-sm-4 item">
                         <div class="team-item">
                              <img src="../frontOffice/images/team-image1.jpg" class="img-responsive" alt="">
                    ...
                    <div class="col-md-4 col-sm-4 item">
                         <div class="team-item">
                              <img src="../frontOffice/images/team-image2.jpg" class="img-responsive" alt="">
                              <div class="team-overlay">
                                   <ul class="social-icon">
                    ...
                    <div class="col-md-4 col-sm-4 item">
                         <div class="team-item">
                              <img src="../frontOffice/images/team-image3.jpg" class="img-responsive" alt="">
                              <div class="team-overlay">
                                   <ul class="social-icon">
                                        <li><a href="#" class="fa fa-instagram"></a></li>
                    ...
                    <div class="col-md-4 col-sm-4 item">
                         <div class="team-item">
                              <img src="../frontOffice/images/team-image4.jpg" class="img-responsive" alt="">
                              <div class="team-overlay">
                                   <ul class="social-icon">
                                        <li><a href="#" class="fa fa-twitter"></a></li>
                                        <li><a href="#" class="fa fa-facebook"></a></li>
